    ...
    <div className='min-h-screen flex flex-col items-start justify-between gap-8 md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <div className='space-y-5'>
        ...
        <div>
          ...
          <div className='flex felx-col items-center max-w-4xl w-full overflow-hidden rounded-md bg-white border border-gray-500/20'>
            ...
            <tbody className='text-sm text-gray-500'>
              {dashboardData.enrolledStudentsData.map((items, index) => (
                <tr key={index} className='border-b border-gray-500/20'>
                  ...
                  {index + 1}</td>
                  <td className='md:px-4 px:2 py-3 flex items-center spac-x-3'>
                    <img 
