...
const CourseDetails = () => {
  ...
  const [isAlreadyEnrolled, setIswAlreadyEnrolled] = useState(false)
  ...
  return courseData ?  (
    ...
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
        ...
        <p>Course by <span className='text-blue-600 underline'> Learnsy </span></p>
      ...
      <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
        ...
        <div className='p-5'>
          ...
          <div className='flex gap-3 itttems-center pt-2'>
          ...
          <button className='md:mt-6 mt4 w-full py-3 rounded bg-blue-600 text-white font-medium'>{isAlreadyEnrolled ? 'Already Enrolled' : 'Enroll Now'}

          </button>

          <div className='pt-6'>
            <p className='md:text-xl text-lg font0medium text-gray-800'>What's the course?</p>
            <ul className='ml-4 pt-3 text-sm md:text-default list-disc text-gray-500'>
              <li>Lifetime acces with free updates.</li>
              <li>Step-by-step, hands-on project gudance.</li>
