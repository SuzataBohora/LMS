...
const CallToAction = () => {
  return (
    <div className='flex flex-col items-center gap-4 pt-10 pb-24 px-8 md:px-0'>
        ...
        <p className='text-gray-500 sm:text-sm'> Indicidunt sint fungiat parriatur cupidates consectetur sit cillum anim id veniam aliqua prodident excepteur commodo do ea.</p>
